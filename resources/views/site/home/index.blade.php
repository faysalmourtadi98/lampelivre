  ...
  <div class="row">
    <div class="col-1">
          <a href="{{Route('about')}}"><img src="{{mix('img/logoLampe4.png')}}"></a>
      <div id="lampeLivre"> 
   ...
   <div class="smallcontainer">
     ...
     <div class="row">
      ...
      <div class="col-4">
        <a href="{{Route('site.products.show',$product->id)}}"><img src="{{mix('img/'.$product->product_image)}}" height="360"></a>
  ...
  <div class="offer">
    <div class="smallcontainer">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{Route('site.products.show',$tab->id)}}"><img src="{{mix('img/'.$tab->product_image)}}" class="offer-img" style="padding-top: 150px;"></a>
