  ...
  <div class="row">
    <div class="col-1">
          <a href="{{Route('about')}}"><img src="{{asset('assets/img/logoLampe4.png')}}"></a>
      <div id="lampeLivre"> 
   ...
   <div class="smallcontainer">
     ...
     <div class="row">
      ...
      <div class="col-4">
        <a href="{{Route('site.products.show',$product->id)}}"><img src="{{asset('/assets/img/'.$product->product_image)}}" height="360"></a>
  ...
  <div class="offer">
    <div class="smallcontainer">
      ...
      <div class="row">
        <div class="col-2">
          <a href="{{Route('site.products.show',$tab->id)}}"><img src="{{asset('assets/img/'.$tab->product_image)}}" class="offer-img" style="padding-top: 150px;"></a>
       ...
       <div class="row">
         <div class="col-3">
          <i class="bi bi-chat-left-quote-fill"></i>
           ...
           <img src="{{asset('/assets/img/user-1.png')}}">
           <h3>Noura Fathi</h3>
         </div>
       <div class="col-3">
        <i class="bi bi-chat-left-quote-fill"></i>
         ...
         <img src="{{asset('/assets/img/user-2.png')}}">
         <h3>Mhand Maous</h3>
       </div>
      <div class="col-3">
        <i class="bi bi-chat-left-quote-fill"></i>
         ...
         <img src="{{asset('/assets/img/user-3.png')}}">
         <h3>Souad Cisse</h3>
       </div>
     </div>
     </div>
