...
<!--------Single product details---------->
  <div class="smallcontainer single-product" >
      <div class="row">
          <div class="col1">
             <img src="{{ secure_asset('img/'.$product->product_image)}}" width="100%" id="ProductImg">
             <div class="small-img-row-">
              <div class="small-img-col-">
                  <img src="{{ secure_asset('img/'.$product->product_image)}}" width="100%" class="small-img">
              </div>
              <div class="small-img-col-">
                <img src="{{ secure_asset('img/'.$product->product_image)}}" width="100%" class="small-img">
            </div>
...
<!--                <select name="product_format" id="product_format">
   ...
   <div class="smallcontainer related_products">
    <div class="row">
      ...
      <div class="col-4">
        <a href="{{Route('site.products.show',$item)}}"><img src="{{ secure_asset('img/'.$item->product_image)}}" width="250" height="350"></a>
