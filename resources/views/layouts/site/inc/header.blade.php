<div class="header">
        <div class="container cont">
           <div class="navBar">
              <div class="logo">
                   <a href="{{Route('site.home.index')}}"><img id="img1" src="{{asset('assets/img/logoBooks.png')}}"></a>
                   <a href="{{Route('site.home.index')}}"><img id="img2" src="{{asset('assets/img/logoLampe4.png')}}"></a>
