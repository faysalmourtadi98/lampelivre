...
<head>
    ...
    @yield('style')
    <!--fontGoogle-->
    <link rel="stylesheet" href="{{ asset('assets/css/Google-Font/Karantina.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/Google-Font/Oswald.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/Google-Font/Playfaire_Display.css') }}">
     <!--BootstrapIcons-->
    <link rel="stylesheet" href="{{ asset('assets/css/Bootstrap-Icon/bootstrap-icons.css') }}">
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <!--titre-->
    @yield('titre')
    <link rel="icon" href="{{asset('assets/img/logoBooks4.png')}}" sizes="16x16"  type="image/png">
...
@include('layouts.site.inc.footer')
   ...
   <script src="{{asset('/assets/js/script_3.js')}}"></script>
