...
<head>
    ...
    <link rel="stylesheet" href="{{mix('css/Font-Awesome/css/all.min.css')}}">
    @yield('style')
    <!--fontGoogle-->
    ...
    <!--titre-->
    @yield('titre')
    <link rel="icon" href="{{mix('img/logoBooks4.png')}}" sizes="16x16"  type="image/png">
...
@include('layouts.site.inc.footer')
   <script src="{{mix('js/script_1.js')}}"></script>
   <script src="{{mix('js/script_2.js')}}"></script>
   <script src="{{mix('js/script_3.js')}}"></script>
